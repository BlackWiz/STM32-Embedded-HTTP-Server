...
extern void SysTick_Handler(void);  /* Defined in delay.c */
extern void SPI1_IRQHandler(void);  /* Defined in spi.c */
...
const uint32_t g_pfnVectors[] = {
    ...
    (uint32_t)&SysTick_Handler,  // 15. SysTick Handler (delay.c)
    ...
    (uint32_t)&SPI1_IRQHandler,  // 25. SPI1 (spi.c)
    (uint32_t)&Default_Handler,  // 26. SPI2
    (uint32_t)&Default_Handler,  // 27. USART1
    (uint32_t)&Default_Handler,  // 28. USART2 (will update when UART driver added)
